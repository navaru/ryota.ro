	...
	<b class={$.container}>
		...
		<Section>
			...
			<p>
				...
				be intelligent than be stupid, that you'd rather be thoughtful than be vapid, that
				...
				insults are pretty lame. Even 'lame' is kind of lame. Saying 'You're lame' is like
				saying 'You walk with a limp.' Yeah, whatever, so does 50 Cent, and he's done all
				right for himself.
			</p>
			...
			<p>
				...
				instead." "Well," said Luke, "you're doing a fantastic job.
			</p>
			...
			<p>
				...
				challenging, that would be no problem. But I arise in the morning torn between a
				desire to improve the world and a desire to enjoy the world. This makes it hard to
				plan the day.
			</p>
			...
			<p>
				...
				this to be normal is obviously some indication of how skewed our perspective tends
				to be.
			</p>
			<p>
				<strong>Phasellus ultrices</strong> nulla quis nibh. Quisque a lectus. Donec
			...
			<hr />
			<p>
				<em>Phasellus ultrices</em> nulla quis nibh. Quisque a lectus. Donec consectetuer
			...
			<p>
				<a href=''>Pellentesque fermentum dolor.</a> Aliquam quam lectus, facilisis
			...
			<blockquote>
				<p>
					“Ooh - a blockquote! Lorem ipsum dolor sit amet, consectetur adipiscing elit.
					Vivamus magna. Cras in mi at felis aliquet congue. Ut a est eget ligula molestie
					gravida. Curabitur massa. Donec eleifend, libero at sagittis mollis, tellus est
			...
			<p>
				Donec consectetuer ligula vulputate sem tristique cursus. Nam nulla quam, gravida
  ...
  line-height: 160%;
		...
		<Section>
			<p>
				...
				<a href='https://www.w3schools.com/tags/'>HTML tags</a>. Of course there are
				classics like <em>emphasis</em>, <strong>strong</strong>, and
				<small>small</small> but there are many others as well. Hover the following text
				for abbreviation tag:
				<abbr title='abbreviation'>abbr</abbr>. Similarly, you can use acronym tag like
				this: <acronym title='For The Win'>ftw</acronym>. You can define{' '}
			...
			<p>
				Please press <kbd>Ctrl</kbd> + <kbd>Shift</kbd>+<kbd>R</kbd> to re-render an MDN
				page.
			</p>
			<p>
				<samp>
		...
		<Section class={$.flex}>
			<b class={$.half}>
				...
				<b class={$.block}>
					...
					<ul class='list list--bare'>
						<li>
							<input name='radio' type='radio' class='radio' checked='checked' readOnly />
							Option 1
						</li>
						<li>
			...
			<b class={$.half}>
				...
				<b class={$.block}>
					...
					<ul class='list list--bare'>
						<li>
							<input name='checkbox' type='checkbox' checked='checked' readOnly />
							Choice A
						</li>
						<li>
